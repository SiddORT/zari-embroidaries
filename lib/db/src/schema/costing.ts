...
export const purchaseOrdersTable = pgTable("purchase_orders", {
  ...
  vendorMode: text("vendor_mode").notNull().default("header"),
...
export const purchaseReceiptsTable = pgTable("purchase_receipts", {
  ...
  totalAmountWithGst: text("total_amount_with_gst"),
  warehouseLocation: text("warehouse_location").notNull().default(""),
  status: text("status").notNull().default("Open"),
  vendorInvoiceNumber: text("vendor_invoice_number"),
  vendorInvoiceDate: timestamp("vendor_invoice_date", { withTimezone: true, mode: 'string' }),
  vendorInvoiceAmount: numeric("vendor_invoice_amount", { precision: 14, scale: 2 }),
  vendorInvoiceFile: text("vendor_invoice_file"),
  vendorInvoiceUploadedAt: timestamp("vendor_invoice_uploaded_at", { withTimezone: true, mode: 'string' }),
  vendorInvoiceCurrencyCode: text("vendor_invoice_currency_code"),
  vendorInvoiceExchangeRate: numeric("vendor_invoice_exchange_rate", { precision: 14, scale: 6 }),
  createdBy: text("created_by").notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
  updatedBy: text("updated_by"),
  updatedAt: timestamp("updated_at", { withTimezone: true }),
