...
export const styleOrderArtworksTable = pgTable("style_order_artworks", {
  ...
  toilePaymentType: text("toile_payment_type"),
  ...
  toilePaymentAmount: text("toile_payment_amount"),
  ...
  patternPaymentStatus: text("pattern_payment_status"),
...
export const insertStyleOrderArtworkSchema = z.object({
  ...
  toilePaymentType: z.string().optional().nullable(),
  ...
  toilePaymentAmount: z.string().optional().nullable(),
  toileTransactionId: z.string().optional().nullable(),
  toileRemarks: z.string().optional().nullable(),
  toileImages: z.array(z.record(z.string(), z.unknown())).optional().default([]),
  patternType: z.string().optional().nullable(),
  patternMakingCost: z.string().optional().nullable(),
  patternDoc: z.array(z.record(z.string(), z.unknown())).optional().default([]),
  patternOuthouseDoc: z.array(z.record(z.string(), z.unknown())).optional().default([]),
  patternVendorId: z.string().optional().nullable(),
  patternVendorName: z.string().optional().nullable(),
  patternPaymentType: z.string().optional().nullable(),
  patternPaymentMode: z.string().optional().nullable(),
  patternPaymentStatus: z.string().optional().nullable(),
  patternPaymentAmount: z.string().optional().nullable(),
  patternTransactionId: z.string().optional().nullable(),
  patternPaymentDate: z.string().optional().nullable(),
  patternRemarks: z.string().optional().nullable(),
  ...
  videos: z.array(z.record(z.string(), z.unknown())).optional().default([]),
});
