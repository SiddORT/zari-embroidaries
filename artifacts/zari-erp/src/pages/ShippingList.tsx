...
import { Package, Truck, Search, X, ExternalLink, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function ShippingList() {
  ...
  }, [page, search, filterStatus, filterVendor, filterRefType, fromDate, toDate]);
        ...
        <div className={`${card} p-4`}>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            <div className="flex gap-2 items-center">
              ...
              {(search || filterStatus || filterVendor || filterRefType || fromDate || toDate) && (
                <button onClick={() => { setSearch(""); setFilterStatus(""); setFilterVendor(""); setFilterRefType(""); setFromDate(""); setToDate(""); setPage(1); }} className="p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition flex-shrink-0" title="Clear filters">
                  <X size={14} />
                </button>
              )}
            </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#C6AF4B]/15">
                  {["Type","Ref ID","Client","Vendor","Tracking No.","Weight","Cost","Status","Ship Date","EDD","ADD"].map(h => (
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={r.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition">
                    ...
                    <td className="px-4 py-3 font-medium text-gray-900">#{r.reference_id}</td>
