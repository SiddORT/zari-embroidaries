...
import { useStyleOrderList, useDeleteStyleOrder, type StyleOrderRecord } from "@/hooks/useStyleOrders";
...
export default function StyleOrders() {
  ...
  const { data, isLoading } = useStyleOrderList({ search, status: statusFilter, priority: priorityFilter, page, limit: 24 });
