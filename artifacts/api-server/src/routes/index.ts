...
import salesSummaryRouter from "./salesSummary";
import purchasesSummaryRouter from "./purchasesSummary";
...
router.use(salesSummaryRouter);
router.use(purchasesSummaryRouter);
